...
| Workflow Run RO-Crate     | `pipeline_info/ro-crate-metadata_<timestamp>.json`          | Machine-readable Workflow Run RO-Crate metadata generated by `nf-prov`.                          |
...
- `pipeline_info/ro-crate-metadata_<timestamp>.json`: Workflow Run RO-Crate metadata at the top level of the results directory.
