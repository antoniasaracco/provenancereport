...
- [#8](https://github.com/nf-core/provenancereport/issues/8) - Add an auditable MultiQC execution report with input and Quarto report checksums and execution environment metadata.
